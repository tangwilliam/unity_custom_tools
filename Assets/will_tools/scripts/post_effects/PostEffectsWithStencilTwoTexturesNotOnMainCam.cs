...
/// 使用注意：stencil区域出现黑边的原因是其边缘存在渐变透明，可以通过增大clip()的值减小黑边
...
/// 
/// </summary>
public class PostEffectsWithStencilTwoTexturesNotOnMainCam : MonoBehaviour {
    ...
    void OnPostRender()
    {
        ...
        PostEffectsUtil.CustomBlit(CameraRenderTexture, BufferForInStencilArea.colorBuffer, CameraRenderTexture.depthBuffer, PostprocessMaterial, 0);
        ...
        Graphics.Blit(bufferFinal, CopyTextureMaterial);
